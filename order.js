...
function showPizza(){
    ...
    console.log(showpizzaArr);
        ...
        if(showpizzaArr[key].foodcategories=="Pizza"){
            orderres+="<div style='display:inline-block;border:1px solid white;border-radius:10px;width:700px;margin-top:20px;background-color:white;'><img src='"+showpizzaArr[key].foodImg+"' style='width:100px;height:100px;float:left;margin-top:5px;margin-left:5px;margin-bottom:5px;'><h3 style='float:left;margin-left:30px'>"
...
function showJuice(){
    ...
    showjuiceArr.forEach(function(value,key){
        if(showjuiceArr[key].foodcategories=="Juice"){
            orderres+="<div style='display:inline-block;border:1px solid white;border-radius:10px;width:700px;margin-top:20px;background-color:white;'><img src='"+showjuiceArr[key].foodImg+"' style='width:100px;height:100px;float:left;margin-top:5px;margin-left:5px;margin-bottom:5px;'><h3 style='float:left;margin-left:30px'>"
...
function showSnacks(){
    ...
    console.log(showsnackArr);
        ...
        if(showsnackArr[key].foodcategories=="Snacks"){
            orderres+="<div style='display:inline-block;border:1px solid white;border-radius:10px;width:700px;margin-top:20px;background-color:white;'><img src='"+showsnackArr[key].foodImg+"' style='width:100px;height:100px;float:left;margin-top:5px;margin-left:5px;margin-bottom:5px;'><h3 style='float:left;margin-left:30px'>"
